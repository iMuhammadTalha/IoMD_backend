...
module.exports.init = async function init() {
    try {
        ...
        const cors = function (req, res, next) {
            const whitelist = ['localhost:3000', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', 'http://localhost:3002', '111.68.101.20:3000', 'http://111.68.101.20:3001', 'http://111.68.101.20', 'http://rhms.seecs.nust.edu.pk'];
